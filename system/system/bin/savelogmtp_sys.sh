...
######################################################################################
	...
	echo 256 > /d/regmap/0-03/count
	echo 0x2600 > /d/regmap/0-03/address
	cat /d/regmap/0-03/data > $SAVE_LOG_PATH/charger_debug/pm8350b_reg.txt
	echo 0x2700 > /d/regmap/0-03/address
	cat /d/regmap/0-03/data >> $SAVE_LOG_PATH/charger_debug/pm8350b_reg.txt
	echo 0x2800 > /d/regmap/0-03/address
	cat /d/regmap/0-03/data >> $SAVE_LOG_PATH/charger_debug/pm8350b_reg.txt
	echo 0x2900 > /d/regmap/0-03/address
	cat /d/regmap/0-03/data >> $SAVE_LOG_PATH/charger_debug/pm8350b_reg.txt
	echo 0x2B00 > /d/regmap/0-03/address
	cat /d/regmap/0-03/data >> $SAVE_LOG_PATH/charger_debug/pm8350b_reg.txt
	echo 0x2C00 > /d/regmap/0-03/address
	cat /d/regmap/0-03/data >> $SAVE_LOG_PATH/charger_debug/pm8350b_reg.txt
	echo 0x3C00 > /d/regmap/0-03/address
	cat /d/regmap/0-03/data >> $SAVE_LOG_PATH/charger_debug/pm8350b_reg.txt
	#cat /d/regmap/0-03/registers >> $SAVE_LOG_PATH/charger_debug/pm8350b_reg_2.txt

	echo 2560 > /d/regmap/4-0b/count
	echo 0x2600 > /d/regmap/4-0b/address
	cat /d/regmap/4-0b/data > $SAVE_LOG_PATH/charger_debug/sbm1396_reg.txt
...
############################################################################################
	...
	echo "savelogmtp_sys.sh: cat /proc/tzdbg"
############################################################################################
...
############################################################################################
	...
	echo "savelogmtp_sys.sh: dumpsys > $SAVE_LOG_PATH/bugreport.txt"
############################################################################################
...
##############################################################################################
	...
	echo "savelogmtp_sys.sh: cp tencent"
##############################################################################################
	echo "savelogmtp_sys.sh: bugreportz +++"
	bugreportz
	echo "savelogmtp_sys.sh: bugreportz ---"
